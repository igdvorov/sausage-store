pipeline {
    ...
    tools {
        ...
        nodejs 'Node16' // А NodeJS нужен для фронта
    }
    ...
    stages {
        ...
        stage('Send POST') {
            steps {
               sh """curl -X POST -H "Content-type: application/json" --data '{"text":"*Дворов Иван* собрал приложение. :cool-doge:"}' https://hooks.slack.com/services/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"""
            }
        }
    }
}
